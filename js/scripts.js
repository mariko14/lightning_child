...
jQuery(function(){
	...
	jQuery("dl.faq dt")
		.append("<br /><a href='#' title='Reveal Answer' class='answer-tab'><span>Answer</span></a>");
	...
	jQuery('.answer-tab').click(function(){
		jQuery('.answer-tab').toggleClass('answer-tab-open');
	});
...
jQuery('.works-cat').find('a').wrapInner('<span></span>');

// 空白テキストノードを除去する
jQuery(function($){
	jQuery(".template_list")
	    .contents()
...
jQuery(function(){
  ...
  jQuery('.scroll').click(function(){
	     ...
	     jQuery("html, body").animate({scrollTop:position}, 1200, "swing");
  });
});
//フォーム
...
jQuery('form').submit(function() {
   ...
   jQuery("html,body").animate({scrollTop:jQuery('#success').offset().top});
...
jQuery(function() {
    ...
    jQuery('#submit-check').on('click', function() {
